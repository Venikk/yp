...
### 01. Preparing data.
#### Проект по теме "Предподготовка данных". В этом проекте необходимо было исследовать исторические данные о клиентах банка и объяснить влияние тех или иных факторов (например, зарплата и семейное положение) на надежность заемщика.
